...
public class RecClosures {
	...
	public static Function<Integer, Integer> intersect2(Function<Integer, Integer> enumA, Function<Integer, Integer> enumB){
		return (x) -> { 
			//System.out.println("Enters here " + x.intValue());
		       if(true){
		    	   //System.out.println("Enters here " + x);
	...
	public static Function<Integer, RecEnum> cartesian(Function<Integer, Integer> enumA, Function<Integer, Integer> enumB){
		return (x) -> { 
				RecEnum enu = new RecEnum();
			//System.out.println("Enters here " + x.intValue());
		       if(true){
		    	   //System.out.println("Enters here " + x);
		    	   x = enumA.apply(x);
