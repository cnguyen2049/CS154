...
public class Lab3Tester {
	...
	public static void Test() {
		...
		System.out.println(r1.matches("000000"));
		System.out.println(r2.matches("111111"));
        ...
        RegEx tune1 = new Iteration(doe); // (do+)? = do*
        RegEx tune2 = new Iteration(ray); //(ray+)? = ray*
        RegEx tune3 = new Iteration(me);  // (me+)? = me*
        RegEx tune4 = new Iteration(fa);  // (fa+)? = fa*  

        // tune5 = (do*)~(ray* | (me* | fa*))
        RegEx tune5 = new Concat(tune1, new Choice(tune2, new Choice(tune3, tune4)));
         System.out.println(tune5.matches("dodododomememe"));
